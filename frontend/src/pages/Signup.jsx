        ...
        <div className="auth-page">
            ...
            <div className="auth-card auth-card-wide">
                ...
                <div className="auth-brand" style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                    ...
                    <p className="auth-subtitle">Join SkillBridge — bridge your skill gap</p>
                </div>
                                ...
                                <div className="pwd-bars">
                                    {[1, 2, 3, 4].map((i) => (
                                        <div
                                            key={i}
                                            className="pwd-bar"
                                            style={{ background: i <= pwdScore ? strengthColor[pwdScore] : '#2a2a3e' }}
                                        />
                                    ))}
                                </div>
                                <span className="pwd-label" style={{ color: strengthColor[pwdScore] }}>
                    ...
                    <div className="field-group">
                        ...
                        <div className="field-input-wrap">
                            ...
                            <input
                                ...
                                className={`field-input ${form.confirm && form.confirm !== form.password ? 'field-input-error' : ''}`}
                                autoComplete="new-password"
                                required
                            />
                            <button
